...
/* DS18B20 ROUTINES */
extern unsigned int temp_sensor_read(unsigned char command);
extern unsigned int DS18B20_read( volatile char *dq_port, unsigned char dq_pin, unsigned char command );
